...
//
// Registered only when BOTH MARINNER_ENABLE_WRITES and
// MARINNER_ENABLE_BROADCASTS are set. A single call can message up to
...
export function registerBroadcastTools(server: McpServer, client: MarinnerClient): void {
  server.registerTool(
    'send_broadcast',
    {
