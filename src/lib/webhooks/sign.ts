...
//
// Every delivery carries an `X-Marinner-Signature` header so receivers
// can verify the request really came from marinner and wasn't tampered
// with or replayed. The scheme is Stripe-style:
//
//   X-Marinner-Signature: t=<unix_seconds>,v1=<hex HMAC-SHA256>
//
...
/**
 * Build the `X-Marinner-Signature` header value for `rawBody`, signed
...
/**
 * Verify a signature header. Exposed so a marinner-to-marinner integration
