...
//
// Why the `marinner_live_` prefix
//   - Self-identifying: a leaked string is instantly recognisable as
//     a marinner key (handy for secret-scanners like GitGuardian).
//   - Forward-compatible: leaves room for a `marinner_test_` variant if
...
export const API_KEY_PREFIX = 'marinner_live_';
