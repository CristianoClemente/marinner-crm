...
describe('hashApiKey', () => {
  it('is deterministic', () => {
    expect(hashApiKey('marinner_live_abc')).toBe(hashApiKey('marinner_live_abc'));
  });

  it('differs for different inputs', () => {
    expect(hashApiKey('marinner_live_abc')).not.toBe(hashApiKey('marinner_live_abd'));
  });
});
...
describe('timingSafeHexEqual', () => {
  it('is true for identical digests', () => {
    const h = hashApiKey('marinner_live_xyz');
