    ...
    for (const n of nodes) {
      if (!reached.has(n.node_key)) {
        issues.push({
          ...
          scope: "node",
          node_key: n.node_key,
          message: `O nó "${n.node_key}" está inacessível a partir do nó de entrada.`,
        });
      }
    }
  }
    ...
    case "send_message": {
      ...
      if (!cfg.next_node_key) {
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `O envio de mensagem aponta para um nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
    ...
    case "send_media": {
      ...
      if (!cfg.media_url?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "media_url",
          message: "O nó de envio de mídia precisa de um arquivo (envie um antes de ativar).",
        });
      }
      ...
      if (!cfg.next_node_key) {
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `O envio de mídia aponta para um nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
    ...
    case "send_list": {
      ...
      if (!cfg.button_label?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "button_label",
          message: "O nó de lista precisa de um rótulo de botão (o texto que expande a lista).",
        });
      }
    ...
    case "collect_input": {
      ...
      if (!cfg.var_key?.trim()) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "var_key",
          message: "O nó de coleta precisa de um var_key para armazenar a resposta.",
        });
        ...
        issues.push({
          ...
          node_key: node.node_key,
          field: "var_key",
          message: `var_key "${cfg.var_key}" deve conter apenas letras, números e underscore, começando por letra ou underscore.`,
        });
      }
      if (!cfg.next_node_key) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: "O nó de coleta deve apontar para um próximo nó.",
        });
      } else if (!knownKeys.has(cfg.next_node_key)) {
        issues.push({
          severity: "error",
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: `O nó de coleta aponta para um nó inexistente "${cfg.next_node_key}".`,
        });
      }
      break;
    }
    ...
    case "set_tag": {
      ...
      if (!cfg.mode || !["add", "remove"].includes(cfg.mode)) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "mode",
          message: "O nó de tag precisa de um modo (adicionar ou remover).",
        });
      }
      if (!cfg.tag_id) {
        issues.push({
      ...
      if (!cfg.next_node_key) {
        issues.push({
          ...
          node_key: node.node_key,
          field: "next_node_key",
          message: "O nó de tag deve apontar para um próximo nó.",
        });
      } else if (!knownKeys.has(cfg.next_node_key)) {
        issues.push({
          severity: "error",
