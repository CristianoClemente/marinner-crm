...
- [GitHub Security Advisories](https://github.com/CristianoClemente/marinner-crm/security/advisories/new)
...
In scope:
- Anything in this repository (`CristianoClemente/marinner-crm`), including webhook and auth
