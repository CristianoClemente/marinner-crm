...
```bash
# 1. Fork on GitHub: https://github.com/CristianoClemente/marinner-crm → Fork
# 2. Clone your fork
...
```bash
git remote add upstream https://github.com/CristianoClemente/marinner-crm.git  # once
git fetch upstream
git checkout main
...
[bug report](https://github.com/CristianoClemente/marinner-crm/issues/new?template=bug_report.yml)
...
- Rebrand. The "CRM Template for WhatsApp" name, favicon, and
  `marinner.com.br` URL belong to the upstream project; please swap them
